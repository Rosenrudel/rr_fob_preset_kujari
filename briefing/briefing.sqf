...
switch (side player) do { //NICHT ENTFERNEN!
    ...
    { //NICHT ENTFERNEN!
		...
		<br/><font color='#FFA500' size='16' face='PuristaBold'>(C/1-201-INF) Einheitenorganisation:</font> //z.B. C Kompanie (C/1-201-INF) => zum Verständnis Charlie Kompanie (Charlie/Erste Brigarde 201tes-Infanteriebattalion)
		...
		<br/>2ter Infanterie-Zug - C´2
		<br/>3ter Infanterie-Zug - C´3 (<-DU)
		<br/>Unterstützungszug schwere Waffen - C´4
		<br/>
		...
		<br/>C´2 nicht bespielt
		<br/>C´3 bespielt
		<br/>C´4 teilweise bespielt
		<br/> 
		...
		<br/>(B/2-3 REC) Luftaufklärung - Vision
		<br/>(C´4´B/1-201-INF) Unterstützungszug schwere Waffen - Hammer
		<br/> 
		...
		<br/><marker name='c11201inf'>(C´1/1-201-INF)</marker>
		<br/><marker name='c21201inf'>(C´2/1-201-INF)</marker>
		<br/><marker name='ch1201inf'>(C´H/1-201-INF)</marker>
		<br/>
		ENDTAB;
		...
		<br/>- Vergiss nicht das du bestimmte Vorgehensweisen auf der Briefingkarte einzeichnen kannst. Visuelle Hilfen sind die besten.
		<br/>
		...
		<br/><font color='#d21111' size='15'>1. Je EInheit/Element:</font>
