/* General config */
L_ambiCivs_maxCivs                 	= 50;		// Maximum number of civilians spawned at the same time
L_ambiCivs_minSpawnDistance 		= 200;		// Minimum distance to players when spawning civilians
L_ambiCivs_maxDistanceToPlayers    	= 600;		// Maximum distance to players, both for spawning and deleting civilians
L_ambiCivs_inhabitChance 			= 0.75;		// Population density. 0 = No house will be rendered suitable, 1 = every house will be suitable
